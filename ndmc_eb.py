...
save_pdf = "/home/sau19/web-scraping/ndmc/bill_pdfs/"
save_png = "/home/sau19/web-scraping/ndmc/bill_receipts/"
csv_log = "/home/sau19/web-scraping/ndmc/bill_logs/log.csv"
fail_log ="/home/sau19/web-scraping/ndmc/fail_logs.txt"
# Firefox settings
...
NDMC_url="https://ccb.ndmc.gov.in/DisplayBill/PayBill.jsp?ne"
...
CONSUMER_NUMBER ='//*[@id="collapse1"]/div[1]/div[1]/div/div[4]/span'
    ...
    def Get_Elec_Bill(self, CA_no):
        ...
        try:
            ...
            if BILL_DUE_DATE[0] == str(previous_dueDate):
                ...
                consumer_number = browser.find_elements_by_xpath( CONSUMER_NUMBER )[0].get_attribute('textContent')
                CON_NUMBER.append( str( consumer_number ) )
            ...
            with open( fail_log , 'a') as file:
                    ...
                    file.write( log_msg )
                    file.close()
            send_email("ykings.saurabh@gmail.com", "Bill Alert Failed ndmc Elec", log_msg )
...
def Save_bill_log():
    ...
    df = pd.DataFrame ( Data , columns=['DATE TIME', 'CUSTOMER NAME', 'CONSUMER NUMBER','ISSUE DATE', \
